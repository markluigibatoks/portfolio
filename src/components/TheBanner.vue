  ...
  <base-container class="lg:py-0 pb-10 text-center lg:text-left lg:border-0 section-divider">
    <div class="lg:pt-[49px] lg:flex lg:justify-between lg:gap-10">
      <div class="lg:order-2 sm:max-w-[638px] sm:h-[518px] mx-auto mb-5 relative w-full">
        <figure class="lg:block relative w-full h-full z-20 flex justify-center items-center">
          <img
        ...
        <figure class="w-1/2 lg:w-2/3 z-10 absolute top-0 left-0">
          <img
        ...
        <figure class="w-1/2 lg:w-2/3 absolute top-1/2 right-0 -translate-y-1/2">
          <img
        ...
        <figure class="w-1/2 lg:w-2/3 z-10 absolute bottom-0 left-0">
          <img
      ...
      <div class="xl:max-w-none lg:max-w-[500px] order-1">
