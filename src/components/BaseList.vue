...
const props = defineProps({
  ...
  mainAxisSpacing: {
    ...
    default: 0,
    validator (value) {
      const gapValues = ['gap-x-0', 'gap-x-0.5', 'gap-x-1', 'gap-x-2', 'gap-x-3', 'gap-x-4', 'gap-x-5', 'gap-x-6', 'gap-x-7', 'gap-x-8', 'gap-x-9', 'gap-x-10', 'gap-x-11', 'gap-x-12']
  ...
  crossAxisSpacing: {
    ...
    default: 0,
    validator (value) {
      const gapValues = ['gap-y-0', 'gap-y-0.5', 'gap-y-1', 'gap-y-2', 'gap-y-3', 'gap-y-4', 'gap-y-5', 'gap-y-6', 'gap-y-7', 'gap-y-8', 'gap-y-9', 'gap-y-10', 'gap-x-11', 'gap-x-12']
...
const spacingClass = computed(() => {
  ...
  if (props.mainAxis === 'horizontal') {
    ...
    list.push(`gap-x-${props.crossAxisSpacing}`, `gap-y-${props.mainAxisSpacing}`)
  }
